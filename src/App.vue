<template>
   <v-app light>
    ...
    <v-content>
      <section>
        <v-parallax :src="images.hero" height="600">
          <v-layout
            column
            align-center
            justify-center
            class="white--text"
          >
            <!-- <img :src="images.vuetify" alt="Vuetify.js" height="200"> -->
            <h1 class="white--text mb-2 display-1 text-xs-center">Subramani Simhachalam</h1>
            <div class="subheading mb-3 text-xs-center">Personal Blog</div>
            <!-- <v-btn
      ...
      <section>
        <v-parallax :src="images.section" height="380">
  ...
  data() {
      return {
        ...
        images: {
                ...
                section: require('./assets/section.jpg'),
                vuetify: require('./assets/vuetify.png')
                //sample: require('./assets/hero.jpg')
            },
        posts: [
            {
